...
| `lss:group-leave` | 🧪 зарезервировано | хост → лист | `GroupLeavePayload` |
...
Последние четыре (группы — с 0.7.0, отключение — с 0.8.0) обслуживают общие права за столом и вне этого сценария не
