...
| `dnd:group-code` | 🧪 зарезервировано | хост → лист | `GroupCodePayload` |
| `dnd:group-status` | 🧪 зарезервировано | лист → хост | `GroupStatusPayload` |
...
Последние три (с 0.6.0) обслуживают общие права за столом и вне этого сценария не
